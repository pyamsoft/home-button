...
import com.pyamsoft.homebutton.settings.SettingsHandler.SettingsEvent.ShowNotification
import com.pyamsoft.homebutton.settings.SettingsView.Callback
    ...
    return listen()
        ...
        .subscribe {
          return@subscribe when (it) {
            is ShowNotification -> delegate.onShowNotificationChangeClicked(it.show)
          }
        }
  }

  sealed class SettingsEvent {
    data class ShowNotification(val show: Boolean) : SettingsEvent()
  }
